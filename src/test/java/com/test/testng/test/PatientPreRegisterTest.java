 ...
 *         20-May-2025
 */
public class PatientPreRegisterTest extends PreRegisterPage {

	public PreRegisterPage register = new PreRegisterPage();
	DBConnectionPre_Registration db = new DBConnectionPre_Registration();
	
	 
	@Test(priority = 1,dataProvider = "ExcelUniversalDataProvider", 
		      dataProviderClass = ExcelSheetDataProvider.class)
	...
	@Test(priority = 2 ,dataProvider = "ExcelUniversalDataProvider", 
		      dataProviderClass = ExcelSheetDataProvider.class)
	public void patientRegistrationTC(String id, String id_no) throws IOException, InterruptedException, InvalidFormatException {
